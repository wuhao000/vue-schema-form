...
import {getComponentType, getFormItemComponent, getRealFields, renderField, SchemaFormEvents, SchemaFormStore} from '@/schema-form/internal/utils';
...
import {addRule, DESKTOP, getColComponent, getConfirmFunction, getOptions, LibComponents, MOBILE, swap, TYPES} from '../utils/utils';
...
export default class FormField extends mixins(Emitter) {
  ...
  public renderInputComponent() {
    ...
    if (field.array && inputFieldDef.forArray === false) {
      ...
      } else if (typeof ArrayComponent === 'object') {
