...
export default class FormField extends mixins(Emitter) {
  ...
  public renderInputComponent() {
    const {props, content, onInput, onArrayItemInput, currentValue, platform, disabled, definition, field} = this;
  ...
  public render() {
    ...
    if (platform === DESKTOP) {
      ...
      const noWrap = type === TYPES.object
        || (component.layout && component.layoutOptions
          && component.layoutOptions.wrapContainer === false)
  ...
  public getFormItemProps() {
    const {definition, field, display, platform} = this;
