    ...
    <pre>
      <demo-wrapper>
        ...
        <template #code><code-container>&lt;template&gt; &lt;a-layout class="demo-wrapper"&gt; &lt;a-layout-content&gt;
          ...
          platform="mobile"/&gt; &lt;v-schema-form v-model:value="value" :actions="actions"
          :effects="effects" :schema="definition" class="demo-form" platform="mobile"&gt;&lt;/v-schema-form&gt;
          &lt;/a-layout-content&gt; &lt;/a-layout&gt; &lt;/template&gt; &lt;script
          lang="ts"&gt; import {message} from 'ant-design-vue'; import {defineComponent,
          ref} from 'vue'; import {EffectsContext} from '../../../../types'; import
          {registerAntdMobile} from '../../../schema-form'; import {SchemaFormEvents}
          from '../../../schema-form/internal/utils'; import effects1 from '../schema/effects1';
          import effects2 from '../schema/effects2'; registerAntdMobile(); export
          default defineComponent({ name: 'Demo', setup() { const value3 = ref({});
          const value2 = ref([{ basic: { bb: 'a', gg: 'fffff' }, dd: [{ ee: '是',
          ff: '是' }] }, { basic: { bb: 'c', cc: '1', gg: '1111' }, dd: [{ ee: '否',
          ff: '是' }] }]); const value = ref({ f1: { aa: true, cc: true } }); const
          actions = [{ text: '提交', props: {type: 'primary'}, action: ($) =&gt; {
