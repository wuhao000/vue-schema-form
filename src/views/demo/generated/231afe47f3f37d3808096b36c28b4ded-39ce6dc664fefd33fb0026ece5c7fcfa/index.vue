    ...
    <pre>
      <demo-wrapper>
        ...
        <template #code><code-container>&lt;template&gt; &lt;a-layout class="demo-wrapper"&gt; &lt;a-layout-content&gt;
          ...
          &lt;/a-layout&gt; &lt;/template&gt; &lt;script lang="ts"&gt; import {message}
          from 'ant-design-vue'; import {EffectsContext} from '../../../../types';
          import {defineComponent, ref} from 'vue'; import {registerElement} from
          '../../../element'; import {SchemaFormEvents} from '../../../schema-form/internal/utils';
          import effects1 from '../schema/effects1'; import effects2 from '../schema/effects2';
          registerElement(); export default defineComponent({ name: 'Demo', setup()
          { const value3 = ref({}); const value2 = ref([{ basic: { bb: 'a', gg: 'fffff'
          }, dd: [{ ee: '是', ff: '是' }] }, { basic: { bb: 'c', cc: '1', gg: '1111'
          }, dd: [{ ee: '否', ff: '是' }] }]); const value = ref({ f1: { aa: true,
          cc: true } }); const actions = [{ text: '提交', props: {type: 'primary'},
          action: ($) =&gt; { console.log($); } }, { text: '重置', action: () =&gt;
          { console.log('reset'); } }, { text: '切换MM', action: ($) =&gt; { $('kk.mm').toggle();
          } }, { text: '校验', action: ($: EffectsContext) =&gt; { $.validate((errors)
          =&gt; { message.error(errors); }); } }]; return { value3, effects3: ($:
          EffectsContext) =&gt; { $('text').subscribe(SchemaFormEvents.fieldKeydown,
