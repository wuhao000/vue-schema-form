...
function (_Vue) {
  ...
  function PlainDisplayField() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PlainDisplayField)).call.apply(_getPrototypeOf2, [this].concat(args))), _initializerDefineProperty(_this, "value", _descriptor, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "title", _descriptor2, _assertThisInitialized(_this)), _temp));
  }
  ...
  _createClass(PlainDisplayField, [{
    ...
    value: function render() {
      ...
      return createVNode("span", null, [value !== undefined && value !== null ? value.toString() : null]);
    }
  }]);
