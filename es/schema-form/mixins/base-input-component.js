...
var BaseFormComponent = (_dec = Component({
  ...
  var _super = _createSuper(BaseFormComponent);
  ...
  _createClass(BaseFormComponent, [{
    key: "props",
    get: function get() {
      return _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.$attrs), this.$props), this.getProps()), this.getSlotProps()), {}, {
