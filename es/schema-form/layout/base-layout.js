...
var BaseLayout = (_dec = Component({
  ...
  type: Array
}), _dec3 = Prop(), _dec4 = Inject(SCHEMA_FORM_STORE_INJECT_KEY), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Vue) {
  _inheritsLoose(BaseLayout, _Vue);
  ...
  function BaseLayout() {
    ...
    _initializerDefineProperty(_assertThisInitialized(_this), "layout", _descriptor2, _assertThisInitialized(_this));
  ...
  return BaseLayout;
}(Vue), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "fields", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
