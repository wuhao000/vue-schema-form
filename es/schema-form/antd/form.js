...
var DForm = (_dec = Component({
  ...
  function DForm() {
    ...
    _initializerDefineProperty(_this, "okCancel", _descriptor, _assertThisInitialized(_this));
    ...
    _initializerDefineProperty(_this, "labelCol", _descriptor5, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "okText", _descriptor6, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "cancelText", _descriptor7, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "inline", _descriptor8, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "labelWidth", _descriptor9, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "hideRequiredMark", _descriptor10, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "layout", _descriptor11, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "model", _descriptor12, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "rules", _descriptor13, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "onSubmit", _descriptor14, _assertThisInitialized(_this));

    _this.prefixCls = 'ant-form';

    _initializerDefineProperty(_this, "wrapperCol", _descriptor15, _assertThisInitialized(_this));

    _this.fields = [];

    _initializerDefineProperty(_this, "form", _descriptor16, _assertThisInitialized(_this));
  ...
  return DForm;
}(Vue), _class3.Item = void 0, _class3.install = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "okCancel", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
