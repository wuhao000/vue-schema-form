...
var DTimePicker = (_dec = Prop({
  ...
  var _super = _createSuper(DTimePicker);
  ...
  function DTimePicker() {
    ...
    _initializerDefineProperty(_this, "format", _descriptor4, _assertThisInitialized(_this));
  ...
  return DTimePicker;
}(BaseFormComponent), _class3.install = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "locale", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
