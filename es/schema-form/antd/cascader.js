...
var DCascader = (_dec = Component({
  ...
  var _super = _createSuper(DCascader);
  ...
  return DCascader;
}(BaseFormComponent), _class3.install = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "placeholder", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
