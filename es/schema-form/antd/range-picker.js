...
var DDateRangePicker = (_dec = Model('change'), _dec2 = Prop({
  ...
  type: Boolean,
  default: undefined
}), _dec6 = Watch('value'), Component(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseFormComponent) {
  _inheritsLoose(DDateRangePicker, _BaseFormComponent);
  ...
  function DDateRangePicker() {
    ...
    _initializerDefineProperty(_assertThisInitialized(_this), "locale", _descriptor2, _assertThisInitialized(_this));

    _initializerDefineProperty(_assertThisInitialized(_this), "localeCode", _descriptor3, _assertThisInitialized(_this));

    _initializerDefineProperty(_assertThisInitialized(_this), "clearable", _descriptor4, _assertThisInitialized(_this));

    _initializerDefineProperty(_assertThisInitialized(_this), "showTime", _descriptor5, _assertThisInitialized(_this));

    return _this;
  }

  var _proto = DDateRangePicker.prototype;
...
}(BaseFormComponent), _defineProperty(_class3, "install", void 0), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "value", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
