...
var DDateRangePicker = (_dec = Model('change'), _dec2 = Prop({
  ...
  var _super = _createSuper(DDateRangePicker);
  ...
  function DDateRangePicker() {
    ...
    _initializerDefineProperty(_this, "locale", _descriptor2, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "localeCode", _descriptor3, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "clearable", _descriptor4, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "showTime", _descriptor5, _assertThisInitialized(_this));
...
}(BaseFormComponent), _class3.install = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "value", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
