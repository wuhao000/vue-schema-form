...
var getSchemaNodeFromPath = function getSchemaNodeFromPath(schema, path) {
  var res = schema;
  var suc = 0;
  var copyPath = Object(_array__WEBPACK_IMPORTED_MODULE_3__[/* toArr */ "d"])(path);
...
var calculateSchemaInitialValues = function calculateSchemaInitialValues(schema, initialValues, callback) {
  ...
  schemaTraverse(schema, function (subSchema, $path, parentPath) {
    ...
    if (Object(_types__WEBPACK_IMPORTED_MODULE_1__["isFn"])($path) && parentPath) {
      Object(_array__WEBPACK_IMPORTED_MODULE_3__[/* each */ "a"])(Object(_array__WEBPACK_IMPORTED_MODULE_3__[/* toArr */ "d"])(Object(_accessor__WEBPACK_IMPORTED_MODULE_2__[/* getIn */ "a"])(initialValues, parentPath)), function (value, index) {
        $path(index);
      });
    } else if ($path) {
...
/* harmony import */ var _Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("d225");
/* harmony import */ var _Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("b0b4");
/* harmony import */ var _uform_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("d5ac");
...
function () {
  function Broadcast() {
    Object(_Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this, Broadcast);

    this.buffer = [];
    this.entries = [];
  }

  Object(_Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Broadcast, [{
    key: "flushBuffer",
...
/* harmony import */ var _Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("d225");
/* harmony import */ var _Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("b0b4");
...
function () {
  function DestructTokenizer(text, handlers) {
    Object(_Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(this, DestructTokenizer);
  ...
  Object(_Users_wuhao_IdeaProjects_github_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(DestructTokenizer, [{
    key: "parse",
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return splitPath; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return takePath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return isPathMatchPatterns; });
...
function (_mixins) {
  ...
  Object(createClass["a" /* default */])(InternalForm, [{
    ...
    value: function getFormProps() {
      var formProps = Object.assign({}, this.store.props, this.props);
...
function registerAntdMobile() {
  ...
  registerMobile('m-input', [TYPES.integer, TYPES.double, TYPES.number], false, function (definition) {
    return {
...
function searchStore(mode, platform, definition) {
  var typeDef = utils_store[mode][platform][definition.type];

  if (!typeDef) {
    console.warn("\u7C7B\u578B".concat(definition.type).concat(definition.array ? '（数组）' : '', "\u6CA1\u6709\u5BF9\u5E94\u7684").concat(mode === 'display' ? '详情' : '编辑', "\u7EC4\u4EF6"));
...
function getPropertyValueByPath(property, currentValue) {
  var propertyPath = Object(utils_path["e" /* splitPath */])(property);
...
function getComponentType(store, definition) {
  ...
  if (component.component === 'empty') {
    console.warn("\u7C7B\u578B".concat(definition.type).concat(definition.array ? '（数组）' : '', "\u6CA1\u6709\u5BF9\u5E94\u7684").concat(store.mode === 'display' ? '展示' : '编辑', "\u7EC4\u4EF6"));
  }
  ...
  if (existsField) {
    ...
    return external_Vue_default.a.observable({
      ...
      onChange: function onChange(value) {
        var subject = store.context.subscribes[SchemaFormEvents.fieldChange];
...
function (_mixins) {
  ...
  function FormField() {
    ...
    _this.currentValue = _this.value !== undefined ? _this.value : null;
    return _this;
  }
  ...
  Object(createClass["a" /* default */])(FormField, [{
    ...
    value: function renderInputComponent() {
      ...
      if (inputFieldDef.layout) {
        ...
        var noWrap = inputFieldDef.layoutOptions && inputFieldDef.layoutOptions.wrapItems === false;
        props.fields = getRealFields(definition.fields).map(function (field, index) {
          return _this2.renderField(field, currentValue, index, !noWrap);
        });
      }

      if (field.array && inputFieldDef.forArray === false) {
        var ArrayComponent = definition.arrayComponent || array_wrapper; // @ts-ignore
    ...
    value: function render() {
      ...
      if (platform === DESKTOP) {
        ...
        var formItem = noWrap ? inputComponent : h(FormItemComponent, helper_default()([{}, {
          ...
          "slot": "label"
        }, [formItemProps.label]), inputComponent]);
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(SchemaForm, [{
    ...
    value: function matchFields(paths) {
      ...
      var matchedPaths = Object(utils_path["d" /* match */])(paths, Object.keys(this.store.fields));
      ...
      var context = function context() {
        ...
        return {
          fields: function fields() {
            return _this3.matchFields(paths);
          },
          toggle: function toggle() {
            _this3.matchFields(paths).forEach(function (field) {
          ...
          takePath: function takePath(number) {
            return context.apply(void 0, _toConsumableArray(Object(utils_path["f" /* takePath */])(paths, number)));
          },
          appendPath: function appendPath(suffix) {
            return context.apply(void 0, _toConsumableArray(Object(utils_path["b" /* appendPath */])(paths, suffix)));
          }
        };
      };
        ...
        context.subscribes[e].subscribe({
          next: function next(v) {
            if (typeof pathsOrHandler === 'function') {
              handler(v);
            } else if (Object(utils_path["c" /* isPathMatchPatterns */])(v.path, typeof pathsOrHandler === 'string' ? [pathsOrHandler] : pathsOrHandler)) {
    ...
    value: function validate() {
      ...
      var fields = Object.keys(this.store.fields).map(function (key) {
        return _this6.store.fields[key];
      });
