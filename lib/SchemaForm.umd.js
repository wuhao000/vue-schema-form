...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(ArrayWrapper, [{
    ...
    value: function renderFields() {
      ...
      if (this.store.platform === 'mobile') {
        return this.$slots.default.map(function (it, index) {
          return h("div", {
            "style": {
              position: 'relative'
            }
    ...
    value: function render() {
      ...
      if (platform === DESKTOP) {
        ...
        var formItem = noWrap ? inputComponent : h(FormItemComponent, helper_default()([{}, {
          "props": formItemProps
        }]), [inputComponent, this.renderNotice()]);
