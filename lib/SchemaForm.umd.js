...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(SchemaForm, [{
    ...
    value: function matchFields(paths) {
      ...
      if (typeof paths === 'string') {
        matchedPaths = Object(utils_path["d" /* match */])([paths], Object.keys(this.store.fields));
    ...
    value: function createContext() {
      ...
      var context = function context(paths) {
        return {
          ...
          takePath: function takePath(number) {
            return context(Object(utils_path["f" /* takePath */])(paths, number));
          },
          appendPath: function appendPath(suffix) {
            return context(Object(utils_path["b" /* appendPath */])(paths, suffix));
          }
        };
      };
