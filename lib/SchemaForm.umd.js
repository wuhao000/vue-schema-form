(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SchemaForm"] = factory(require("Vue"));
	else
		root["SchemaForm"] = factory(root["Vue"]);
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("d5ac");
/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "clone")) __webpack_require__.d(__webpack_exports__, "clone", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["clone"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "globalThisPolyfill")) __webpack_require__.d(__webpack_exports__, "globalThisPolyfill", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["globalThisPolyfill"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isArr")) __webpack_require__.d(__webpack_exports__, "isArr", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isArr"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isEmpty")) __webpack_require__.d(__webpack_exports__, "isEmpty", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isEmpty"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isFn")) __webpack_require__.d(__webpack_exports__, "isFn", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isFn"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isObj")) __webpack_require__.d(__webpack_exports__, "isObj", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isObj"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isRegExp")) __webpack_require__.d(__webpack_exports__, "isRegExp", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isRegExp"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_types__WEBPACK_IMPORTED_MODULE_4__, "isStr")) __webpack_require__.d(__webpack_exports__, "isStr", function() { return _types__WEBPACK_IMPORTED_MODULE_4__["isStr"]; });
...
/* harmony import */ var D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("d225");
/* harmony import */ var D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("b0b4");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("d5ac");
/* harmony import */ var _array__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("4ed9");
...
function () {
  function Broadcast() {
    Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this, Broadcast);

    this.buffer = [];
    this.entries = [];
  }

  Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Broadcast, [{
    key: "flushBuffer",
    value: function flushBuffer(_ref) {
      var subscriber = _ref.subscriber,
          subscription = _ref.subscription;
      Object(_array__WEBPACK_IMPORTED_MODULE_5__[/* each */ "a"])(this.buffer, function (_ref2) {
        var payload = _ref2.payload,
            filter = _ref2.filter;

        if (Object(_types__WEBPACK_IMPORTED_MODULE_4__["isFn"])(filter)) {
    ...
    value: function notify(payload, filter) {
      ...
      Object(_array__WEBPACK_IMPORTED_MODULE_5__[/* each */ "a"])(this.entries, function (_ref3) {
    ...
    value: function subscribe(subscriber, subscription) {
      ...
      if (!Object(_types__WEBPACK_IMPORTED_MODULE_4__["isFn"])(subscriber)) {
        return noop;
      }
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("d5ac");

var toArr = function toArr(val) {
  return Object(_types__WEBPACK_IMPORTED_MODULE_0__["isArr"])(val) ? val : val ? [val] : [];
};
function each(val, iterator, revert) {
  if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isArr"])(val) || Object(_types__WEBPACK_IMPORTED_MODULE_0__["isStr"])(val)) {
    if (revert) {
  ...
  } else if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isObj"])(val)) {
    var key;
...
function map(val, iterator, revert) {
  var res = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isArr"])(val) || Object(_types__WEBPACK_IMPORTED_MODULE_0__["isStr"])(val) ? [] : {};
  each(val, function (item, key) {
    var value = iterator(item, key);

    if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isArr"])(res)) {
      res.push(value);
    } else {
      res[key] = value;
    }
...
/* harmony import */ var core_js_modules_es6_set__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("4f7f");
...
/* harmony import */ var core_js_modules_es6_weak_set__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("c02b");
...
/* harmony import */ var core_js_modules_es6_weak_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("10ad");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("d5ac");
/* harmony import */ var _globalThis__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("a20a");
...
var isNativeObject = function isNativeObject(values) {
  for (var i = 0; i < NATIVE_KEYS.length; i++) {
    ...
    if (Array.isArray(item) && item[0]) {
      if (_globalThis__WEBPACK_IMPORTED_MODULE_10__[/* globalThisPolyfill */ "a"][item[0]] && values instanceof _globalThis__WEBPACK_IMPORTED_MODULE_10__[/* globalThisPolyfill */ "a"][item[0]]) {
        return item[1] ? item[1] : item[0];
      }
    } else {
      if (_globalThis__WEBPACK_IMPORTED_MODULE_10__[/* globalThisPolyfill */ "a"][item] && values instanceof _globalThis__WEBPACK_IMPORTED_MODULE_10__[/* globalThisPolyfill */ "a"][item]) {
        return item;
      }
    }
  }
...
var clone = function clone(values, filter) {
  ...
  if (Array.isArray(values)) {
    ...
    return Object(_types__WEBPACK_IMPORTED_MODULE_9__["isFn"])(nativeClone) ? nativeClone(values) : values;
    ...
    for (var key in values) {
      if (Object.hasOwnProperty.call(values, key)) {
        if (Object(_types__WEBPACK_IMPORTED_MODULE_9__["isFn"])(filter)) {
...
/* harmony import */ var D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("d225");
/* harmony import */ var D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("b0b4");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("d5ac");
/* harmony import */ var _array__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("4ed9");
/* harmony import */ var _lru__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("6696");
...
function toString(val) {
  ...
  if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(val)) {
    return val.join('.');
  }

  return Object(_types__WEBPACK_IMPORTED_MODULE_8__["isStr"])(val) ? val : '';
}

var PathCache = new _lru__WEBPACK_IMPORTED_MODULE_10__[/* LRUMap */ "a"](1000);
function getPathSegments(path) {
  if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(path)) {
    return path;
  }

  if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isStr"])(path) && path) {
  ...
  if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isNum"])(path)) {
    return [path];
  }
...
function () {
  function DestructTokenizer(text, handlers) {
    Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(this, DestructTokenizer);
  ...
  Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(DestructTokenizer, [{
    key: "parse",
...
var parseDestruct = function parseDestruct(str) {
  if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isStr"])(str)) {
    return str;
  }
  ...
  new DestructTokenizer(str, {
    ...
    destructKey: function destructKey(key, readyReplace) {
      ...
      if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(destruct)) {
        destruct.push(key);
      } else if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isPlainObj"])(destruct)) {
    ...
    destructArrayStart: function destructArrayStart() {
      ...
      if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isPlainObj"])(tail)) {
        tail[token] = destruct;
      } else if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(tail)) {
        tail.push(destruct);
      }
...
var traverse = function traverse(obj, callback) {
  var internalTraverse = function internalTraverse(internalObj, path) {
    if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isStr"])(internalObj)) {
      return callback(internalObj, internalObj);
    }

    Object(_array__WEBPACK_IMPORTED_MODULE_9__[/* each */ "a"])(internalObj, function (item, key) {
      var newPath = path.concat(key);

      if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(item) || Object(_types__WEBPACK_IMPORTED_MODULE_8__["isPlainObj"])(item)) {
...
var mapReduce = function mapReduce(obj, callback) {
  var internalTraverse = function internalTraverse(internalObj, path) {
    return Object(_array__WEBPACK_IMPORTED_MODULE_9__[/* map */ "c"])(internalObj, function (item, key) {
      var newPath = path.concat(key);
...
var parsePaths = function parsePaths(path) {
  ...
  if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isStr"])(parsed.destruct)) {
    return path;
...
var resolveGetIn = function resolveGetIn(get) {
  ...
  return function (obj, path, value) {
    ...
    if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(ast.destruct) && !Object(_types__WEBPACK_IMPORTED_MODULE_8__["isPlainObj"])(ast.destruct)) {
...
var resolveUpdateIn = function resolveUpdateIn(update, internalGetIn) {
  ...
  return function (obj, path, value, getSchema) {
    ...
    if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(paths)) {
      return update(obj, path, value, getSchema);
    }

    if (paths && paths.length) {
      Object(_array__WEBPACK_IMPORTED_MODULE_9__[/* each */ "a"])(paths, function (_ref) {
...
var resolveExistIn = function resolveExistIn(has) {
  ...
  return function (obj, path) {
    ...
    if (paths && paths.length) {
      return Object(_array__WEBPACK_IMPORTED_MODULE_9__[/* every */ "b"])(paths, function (_ref2) {
...
function _getIn(obj, path, value) {
  if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isObj"])(obj) || !path) {
    return obj;
  }
...
function _setIn(obj, path, value, getSchema) {
  ...
  if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isObj"])(copyObj) || !path) {
    return;
  }
  ...
  for (var i = 0; i < pathArr.length; i++) {
    ...
    if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isObj"])(copyObj[p])) {
...
function _deleteIn(obj, path) {
  ...
  for (var i = 0; i < pathArr.length; i++) {
    ...
    if (i === pathArr.length - 1) {
      if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isArr"])(copyObj)) {
        copyObj.splice(p, 1);
      } else {
        delete copyObj[p];
      }
    ...
    if (!Object(_types__WEBPACK_IMPORTED_MODULE_8__["isObj"])(copyObj)) {
      return;
    }
  }
}
...
/* harmony import */ var core_js_modules_es6_string_starts_with__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("f559");
...
/* harmony import */ var D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("75fc");
/* harmony import */ var core_js_modules_es6_regexp_split__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("28a5");
/* harmony import */ var core_js_modules_es6_regexp_split__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_regexp_split__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var lodash_flatten__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("2fb4");
...
function match(paths, fields) {
  return lodash_flatten__WEBPACK_IMPORTED_MODULE_8___default()(paths.map(function (it) {
...
function replaceLastPath(paths, last) {
  return paths.map(function (it) {
    ...
    splits.splice.apply(splits, [splits.length - last.length, last.length].concat(Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(last)));
...
function isPathMatchPatterns(field, patterns) {
...
function matchSinglePath(path, fields) {
  if (isFuzzyPath(path)) {
    if (path.startsWith('#')) {
...
var isArray = _types__WEBPACK_IMPORTED_MODULE_8__["isArr"];
  ...
  if (a && b && Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(a) === 'object' && Object(D_workspace_aegis_vue_schema_form_node_modules_babel_runtime_corejs2_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(b) === 'object') {
    ...
    for (i = length; i-- !== 0;) {
      ...
      if (key === '_owner' && a.$$typeof) {
        ...
        if (Object(_types__WEBPACK_IMPORTED_MODULE_8__["isFn"])(filter)) {
          if (filter({
            a: a[key],
            b: b[key]
          }, key)) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("43df");
/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "clone")) __webpack_require__.d(__webpack_exports__, "clone", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["clone"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "each")) __webpack_require__.d(__webpack_exports__, "each", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["each"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "getIn")) __webpack_require__.d(__webpack_exports__, "getIn", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["getIn"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "globalThisPolyfill")) __webpack_require__.d(__webpack_exports__, "globalThisPolyfill", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["globalThisPolyfill"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isArr")) __webpack_require__.d(__webpack_exports__, "isArr", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isArr"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isEmpty")) __webpack_require__.d(__webpack_exports__, "isEmpty", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isEmpty"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isEqual")) __webpack_require__.d(__webpack_exports__, "isEqual", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isEqual"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isFn")) __webpack_require__.d(__webpack_exports__, "isFn", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isFn"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isObj")) __webpack_require__.d(__webpack_exports__, "isObj", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isObj"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isRegExp")) __webpack_require__.d(__webpack_exports__, "isRegExp", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isRegExp"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "isStr")) __webpack_require__.d(__webpack_exports__, "isStr", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["isStr"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "reduce")) __webpack_require__.d(__webpack_exports__, "reduce", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["reduce"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_utils__WEBPACK_IMPORTED_MODULE_2__, "toArr")) __webpack_require__.d(__webpack_exports__, "toArr", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["toArr"]; });
...
function swap(array, x, y) {
  array.splice.apply(array, [x, 1].concat(Object(toConsumableArray["a" /* default */])(array.splice(y, 1, array[x]))));
}
var LibComponents = {
  icons: null,
  alert: null,
...
function setStructValue(parentValue, struct, structValue, vue) {
...
var field_setFieldValue = function setFieldValue(parentValue, field, v, vue) {
...
// CONCATENATED MODULE: ./src/schema-form/utils/register.ts
...
var register_addComponent = function addComponent(options) {
  if (Array.isArray(options.types)) {
    ...
    var typeDef = register_store[mode][options.platforms];
...
var register_registerDesktop = function registerDesktop(component, types) {
...
var register_registerResponsiveComponent = function registerResponsiveComponent(component, types) {
  var forArray = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var getProps = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
...
function searchStore(mode, platform, definition) {
  ...
  var typeDef = register_store[mode][platform][type];
...
var register_getComponent = function getComponent(platform, definition) {
  return searchStore(Mode.edit, platform, definition);
};
var register_getDisplayComponent = function getDisplayComponent(platform, definition) {
...
function getComponentType(store, definition) {
  ...
  if (!store.editable || definition.editable === false) {
    component = register_getDisplayComponent(store.platform, definition);
  } else {
    component = register_getComponent(store.platform, definition);
  }
...
function utils_renderField(pathPrefix, store, field, currentValue, index, wrap, h, vue) {
  if (field.slot) {
  ...
  return h(internal_field, helper_default()([{}, {
    ...
    "on": {
      "input": function input(v) {
        field_setFieldValue(value, iField, v, vue);
      }
    },
...
function (_mixins) {
  ...
  function FormField() {
    ...
    _this.currentValue = Object(utils["clone"])(_this.value) || null;
    return _this;
  }
  ...
  Object(createClass["a" /* default */])(FormField, [{
    ...
    value: function renderField(field, currentValue, index, wrap) {
      return utils_renderField(this.pathPrefix, this.store, field, currentValue, index, wrap, this.$createElement, this);
    }
  }, {
    ...
    value: function valueChanged(value) {
      if (!Object(utils["isEqual"])(this.currentValue, value)) {
        this.currentValue = Object(utils["clone"])(value);
      }
    }
  }, {
    key: "created",
    value: function created() {
      ...
      field.setGetValue = function (value) {
        if (value !== undefined) {
          _this2.currentValue = Object(utils["clone"])(value);
        } else {
    ...
    value: function renderInputComponent() {
      ...
      if ((!this.store.editable || !this.field.editable) && field.displayValue) {
        ...
        if (Object(esm_typeof["a" /* default */])(displayValue) === 'object') {
          return displayValue;
        } else {
...
__decorate([Watch('currentValue', {
  deep: true
})], field_FormField.prototype, "currentValueChanged", null);
...
// CONCATENATED MODULE: ./src/schema-form/antd/button.tsx
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(AntdButton, [{
    ...
    value: function render() {
      var h = arguments[0];
      return h("d-button", helper_default()([{}, {
        "attrs": this.$attrs
      }, {
        "attrs": {
          "html-type": "button"
...
__decorate([Prop()], button_AntdButton.prototype, "action", void 0);

__decorate([Prop()], button_AntdButton.prototype, "title", void 0);

__decorate([Inject('store')], button_AntdButton.prototype, "store", void 0);

button_AntdButton = __decorate([vue_class_component_esm({
  name: 'AntdButton'
})], button_AntdButton);
/* harmony default export */ var antd_button = (button_AntdButton);
...
// CONCATENATED MODULE: ./src/schema-form/antd/url.tsx
...
function (_mixins) {
  ...
  function DUrlInput() {
    Object(classCallCheck["a" /* default */])(this, DUrlInput);

    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(DUrlInput).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(DUrlInput, [{
    key: "render",
    value: function render() {
      var _this = this;
...
var upload_component = normalizeComponent(
  ...
  uploadvue_type_template_id_46f2687a_render,
  staticRenderFns,
  false,
  null,
  null,
...
// CONCATENATED MODULE: ./src/schema-form/antd/register.ts
...
function registerAntd() {
  ...
  register_registerDesktop('d-range-picker', [TYPES.daterange], false);
  register_registerDesktop('d-input', [TYPES.string], false);
  register_registerDesktop(antd_url, TYPES.url, false);
  register_registerDesktop('d-textarea', [TYPES.text], false);
  register_registerDesktop('d-date-picker', [TYPES.date, TYPES.year, TYPES.month, TYPES.datetime], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register_registerDesktop('d-time-picker', [TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register_registerDesktop('d-input-number', [TYPES.double, TYPES.integer, TYPES.number], false);
  register_registerDesktop('d-checkbox', TYPES.checkbox, false);
  register_registerDesktop('d-switch', TYPES.boolean);
  register_registerDesktop('d-select', TYPES.select, null, function (field) {
    return {
  ...
  register_registerDesktop(antd_button, TYPES.button, null, function (field) {
    return {
      title: field.title
    };
  });
  register_registerDesktop(upload, TYPES.upload, null, function (def) {
    return {
      multiple: def.array
    };
  });
  register_registerDesktop('d-cascader', TYPES.cascader, false, function (def) {
    return {
      options: def.enum
    };
  });
  register_registerDesktop('d-checkbox-group', TYPES.expandSelect, true, function (field) {
    return {
      options: utils_getOptions(field),
      multiple: true
    };
  });
  register_registerDesktop('d-radio-group', TYPES.expandSelect, false, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerDesktop('d-color-picker', 'color');
  register_registerDesktop('d-rate', TYPES.rate);
  register_registerDesktop('d-transfer', TYPES.transfer, false, function (def) {
...
// CONCATENATED MODULE: ./src/schema-form/element/button.tsx
...
__decorate([Prop()], element_button_AntdButton.prototype, "action", void 0);

__decorate([Prop()], element_button_AntdButton.prototype, "title", void 0);

__decorate([Inject('store')], element_button_AntdButton.prototype, "store", void 0);

element_button_AntdButton = __decorate([vue_class_component_esm({
  name: 'AntdButton'
})], element_button_AntdButton);
/* harmony default export */ var element_button = (element_button_AntdButton);
...
// CONCATENATED MODULE: ./src/schema-form/element/url.vue?vue&type=script&lang=ts&
 /* harmony default export */ var element_urlvue_type_script_lang_ts_ = (urlvue_type_script_lang_ts_); 
...
var url_component = normalizeComponent(
  element_urlvue_type_script_lang_ts_,
...
/* harmony default export */ var element_url = (url_component.exports);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"129c09bb-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/schema-form/element/upload.vue?vue&type=template&id=5c645f1c&
var uploadvue_type_template_id_5c645f1c_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('el-upload',_vm._b({class:'uploader--' + _vm.listType,attrs:{"file-list":_vm.fileList},scopedSlots:_vm._u([{key:"file",fn:function(ref){
var file = ref.file;
...
var uploadvue_type_template_id_5c645f1c_staticRenderFns = []


// CONCATENATED MODULE: ./src/schema-form/element/upload.vue?vue&type=template&id=5c645f1c&
...
var element_upload_component = normalizeComponent(
  ...
  uploadvue_type_template_id_5c645f1c_render,
  uploadvue_type_template_id_5c645f1c_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./src/schema-form/element/register.ts
...
function registerElement() {
  ...
  register_registerDesktop('el-transfer', TYPES.transfer, false, function (field) {
  ...
  register_registerDesktop(element_button, TYPES.button, null, function (field) {
    return {
      title: field.title
    };
  });
  register_registerDesktop(element_upload, TYPES.upload, null, function (field) {
    return {
      multiple: field.array
    };
  });
  register_registerDesktop('el-input', TYPES.string, false);
  register_registerDesktop(element_url, TYPES.url, false);
  register_registerDesktop('el-input', [TYPES.text], false, function () {
    return {
      type: 'textarea'
    };
  });
  register_registerDesktop('el-time-picker', TYPES.time, false);
  register_registerDesktop('el-rate', TYPES.rate, false);
  register_registerDesktop('el-date-picker', [TYPES.date, TYPES.daterange, TYPES.year, TYPES.month, TYPES.datetime], false, function (definition) {
    return {
      type: definition.type.toLowerCase()
    };
  });
  register_registerDesktop('el-input-number', [TYPES.double, TYPES.integer, TYPES.number], false);
  register_registerDesktop('el-switch', [TYPES.boolean], false);
  register_registerDesktop('el-ext-select', [TYPES.select], null, function (definition) {
    return {
      multiple: definition.array,
      options: utils_getOptions(definition)
    };
  });
  register_registerDesktop('el-checkbox', TYPES.checkbox, false);
  register_registerDesktop('el-slider', TYPES.range, false, function (field) {
    var props = {
      range: true
    };
  ...
  register_registerDesktop('el-ext-radio', [TYPES.expandSelect], false, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerDesktop('el-ext-checkbox', [TYPES.expandSelect], true, function (field) {
    return {
      options: utils_getOptions(field),
      multiple: true
    };
...
// CONCATENATED MODULE: ./src/schema-form/layout/register.ts
...
var register_registerLayout = function registerLayout(options) {
  register_addComponent({
    component: options.component,
    platforms: options.platforms,
    types: options.types,
...
__decorate([Inject('store')], image_picker_MobileImagePicker.prototype, "store", void 0);
...
// CONCATENATED MODULE: ./src/schema-form/mobile/button.tsx
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(AntdButton, [{
    ...
    value: function render() {
      var h = arguments[0];
      return h("m-button", helper_default()([{}, {
        "props": this.$attrs
      }, {
        "on": {
          "click": this.onClick
...
__decorate([Prop()], mobile_button_AntdButton.prototype, "action", void 0);

__decorate([Prop()], mobile_button_AntdButton.prototype, "title", void 0);

__decorate([Inject('store')], mobile_button_AntdButton.prototype, "store", void 0);

mobile_button_AntdButton = __decorate([vue_class_component_esm({
  name: 'AntdButton'
})], mobile_button_AntdButton);
/* harmony default export */ var mobile_button = (mobile_button_AntdButton);
...
// CONCATENATED MODULE: ./src/schema-form/mobile/register.ts
...
var register_registerMobile = function registerMobile(component, types) {
  var forArray = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var getProps = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
...
function registerAntdMobile() {
  ...
  register_registerMobile('m-input', [TYPES.string, TYPES.url], false);
  register_registerMobile('m-date-picker-item', [TYPES.date, TYPES.datetime, TYPES.month, TYPES.year, TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register_registerMobile('m-input', [TYPES.double, TYPES.number], false, function (definition) {
    return {
  ...
  register_registerMobile(stepper_item, [TYPES.integer], false, function (field) {
    return {
      title: field.title
    };
  });
  register_registerMobile('m-textarea', [TYPES.text], false);
  register_registerMobile(schema_form_mobile_image_picker, [TYPES.picture, TYPES.file], null, function (def) {
    return {
      multiple: def.array
    };
  });
  register_registerMobile(mobile_button, TYPES.button);
  register_registerMobile('m-switch-item', [TYPES.boolean], false);
  register_registerMobile('m-checkbox-popup-list', [TYPES.select], true, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerMobile('m-radio-popup-list', [TYPES.select], false, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerMobile('m-checkbox-list', [TYPES.expandSelect], true, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerMobile('m-radio-list', [TYPES.expandSelect], false, function (field) {
    return {
      options: utils_getOptions(field)
    };
  });
  register_registerMobile('m-calendar-item', TYPES.daterange, false);
}
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(SchemaForm, [{
    ...
    value: function matchFields(paths) {
      ...
      var matchedPaths = Object(utils_path["e" /* match */])(paths, this.store.fields);
      ...
      var context = function context() {
        ...
        return {
          ...
          takePath: function takePath(number) {
            return context.apply(void 0, Object(toConsumableArray["a" /* default */])(Object(utils_path["h" /* takePath */])(_paths, number)));
          },
          appendPath: function appendPath(suffix) {
            return context.apply(void 0, Object(toConsumableArray["a" /* default */])(Object(utils_path["b" /* appendPath */])(_paths, suffix)));
          },
          ...
          replaceLastPath: function replaceLastPath() {
            ...
            return context.apply(void 0, Object(toConsumableArray["a" /* default */])(Object(utils_path["f" /* replaceLastPath */])(_paths, last)));
          }
        };
      };
          ...
          next: function next(v) {
            _this3.$nextTick(function () {
              if (typeof pathsOrHandler === 'function') {
                pathsOrHandler(v);
              } else if (Object(utils_path["d" /* isPathMatchPatterns */])(v.field, typeof pathsOrHandler === 'string' ? [pathsOrHandler] : pathsOrHandler)) {
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return uform_validator(this.currentValue, this.store.fields, true);
    ...
    value: function render() {
      ...
      var content = [this.$slots.header, utils_renderField(null, store, rootFieldDef, currentValue, 0, false, this.$createElement, this)];
    ...
    value: function setCurrentValue() {
      if (!(this.currentValue && Object(utils["isEqual"])(this.value, this.currentValue))) {
        if (this.value) {
          this.currentValue = Object(utils["clone"])(this.value);
...
form_SchemaForm.registerLayout = register_registerLayout;
...
__decorate([Watch('value')], form_SchemaForm.prototype, "valueChanged", null);

__decorate([Watch('currentValue', {
  deep: true
})], form_SchemaForm.prototype, "currentValueChanged", null);
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(PlainDisplayField, [{
    ...
    value: function render() {
      ...
      return h("span", [value !== undefined && value !== null ? value.toString() : null]);
    }
  }]);
...
function (_mixins) {
  ...
  Object(createClass["a" /* default */])(InternalForm, [{
    ...
    key: "valueChanged",
    value: function valueChanged(value) {
      if (!Object(utils["isEqual"])(value, this.currentValue)) {
        if (this.definition.array) {
          this.currentValue = Object(utils["clone"])(value) || [];
        } else {
          this.currentValue = Object(utils["clone"])(value) || {};
    ...
    value: function getGroups(currentValue) {
      ...
      getRealFields(this.definition.fields).forEach(function (field, index) {
        var vnode = _this.renderField(field, currentValue, index, true);
...
__decorate([Watch('currentValue', {
  deep: true
})], form_InternalForm.prototype, "currentValueChanged", null);
...
// CONCATENATED MODULE: ./src/schema-form/display/register.ts
...
//# sourceMappingURL=SchemaForm.umd.js.map