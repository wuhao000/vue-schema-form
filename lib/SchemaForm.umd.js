...
// CONCATENATED MODULE: ./src/schema-form/base-array-component.tsx
...
/* harmony default export */ var base_array_component = ({
  ...
  watch: {
    ...
    current: function current(_current) {
      this.$emit('input', _current);
      this.$emit('change', _current);
    }
  },
  render: function render() {
    ...
    var content = [this.current.map(function (v, index) {
      var input = h(InputComponent, helper_default()([{}, {
        "attrs": Object.assign({
          arrayIndex: index
        }, _this.$attrs)
      }, {
        "on": {
          "removeArrayItem": function removeArrayItem(index) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 3;
                      return this.$mconfirm('确定删除此项吗?', '提示');
        ...
        "model": {
          value: _this.current[index],
          callback: function callback($$v) {
            _this.$set(_this.current, index, $$v);
          }
        }
      }]));

      if (_this.component === ASchemaForm) {
        return input;
      }
...
registerDisplay(time_display_field, [DESKTOP, MOBILE], ['datetime', 'date', 'time']);
registerDisplay(plain_display_field, [DESKTOP, MOBILE], ['string', 'text', 'url', 'integer', 'double'], false);
registerDisplay(select_display_field, [DESKTOP, MOBILE], ['select', 'expand-select'], null);
register(ASchemaForm, [DESKTOP, MOBILE], TYPES.subForm, false, function (definition, platform) {
  return {
    platform: platform,
    definition: {
...
registerDisplay(ASchemaForm, [DESKTOP, MOBILE], TYPES.subForm, false, function (definition, platform) {
  return {
    platform: platform,
    definition: {
      fields: definition.fields
...
function registerAntdMobile() {
  ...
  register('m-input', MOBILE, [TYPES.integer, TYPES.double], false, function (definition) {
    return {
...
function searchStore(mode, platform, definition) {
  ...
  if (definition.array) {
    ...
    if (typeDef[2]) {
      res = {
        component: base_array_component,
        forArray: true,
...
var utils_getOptions = function getOptions(definition) {
  if (definition.props && definition.props.options) {
    ...
    } else if (typeof_typeof(definition.props.options) === 'object') {
      return definition.props.options || [];
    }
  } else {
    return [];
...
var getDefaultValue = function getDefaultValue(definition) {
...
function addRule(rules, field, rule) {
  ...
  if (field.array) {
    ...
    if (options.length) {
      validateType = typeof_typeof(getOptionProperty(options[0], field.props && field.props.valueProperty || 'value'));
    }
  }
...
function (_Vue) {
  ...
  _createClass(FormField, [{
    ...
    value: function renderInputComponent() {
      ...
      var InputFieldDefinition = this.componentType.component;
      ...
      return h(InputFieldDefinition, helper_default()([{}, {
        "attrs": props
      }, {
        "attrs": {
    ...
    value: function render() {
      ...
      var item = null;
      var FormItemComponent = getFormComponent(this.platform) + '-item';
      var ColComponent = getColComponent();

      if (platform === DESKTOP) {
        var formItem = this.definition.type === TYPES.subForm ? component : h(FormItemComponent, helper_default()([{}, {
    ...
    get: function get() {
      ...
      if (component.component === 'empty') {
        console.warn("\u7C7B\u578B".concat(this.definition.type).concat(this.definition.array ? '（数组）' : '', "\u6CA1\u6709\u5BF9\u5E94\u7684").concat(this.display ? '展示' : '编辑', "\u7EC4\u4EF6"));
      }
    ...
    key: "options",
    get: function get() {
      return utils_getOptions(this.definition);
    }
  }, {
    key: "props",
    get: function get() {
      var definition = this.definition;
      var props = Object.assign({}, this.componentType.getProps(definition));
...
__decorate([Prop(Object)], field_FormField.prototype, "formValue", void 0);
...
__decorate([Prop({
  type: Boolean,
  default: false
})], field_FormField.prototype, "validate", void 0);
...
var form_SchemaForm = SchemaForm_1 =
/*#__PURE__*/
function (_Vue) {
  ...
  _createClass(SchemaForm, [{
    ...
    key: "setDefaultValue",
    value: function setDefaultValue(property, tmpValue, field) {
      var _this2 = this;
        ...
        if (_this3.definition.array) {
          currentValue.forEach(function (tmpValue) {
            if (property.includes('.')) {
              _this3.setDefaultValue(property, tmpValue, field);
            } else {
              if (!tmpValue || tmpValue[property] === undefined) {
                _this3.$set(tmpValue, property, getDefaultValue(field));
              } else if (value && value.length) {
                _this3.$set(tmpValue, property, value[0][field.property]);
              }
            }
          });
        } else {
          ...
          if (property.includes('.')) {
            ...
            if (!tmpValue || tmpValue[property] === undefined) {
              ...
              _this3.$set(tmpValue, property, value[field.property]);
            }
          }
        }
      });
    ...
    value: function renderField(field, currentValue, index) {
      ...
      if (field.property.includes('.')) {
        value = SchemaForm_1.getPropertyValueByPath(field.property.substr(0, field.property.lastIndexOf('.')), currentValue);
      } else {
        value = currentValue;
      }
      ...
      var propertyName = field.property.substr(field.property.lastIndexOf('.') + 1); // @ts-ignore

      return this.calcShowState(field) ? h(schema_form_field, {
        "attrs": {
        ...
        "on": {
          "change": function change(value) {
            _this7.onFieldValueChange(value, field);
          }
        },
        "model": {
          value: value[propertyName],
          callback: function callback($$v) {
            _this7.$set(value, propertyName, $$v);
          }
        }
      }) : null;
    }
    ...
    value: function renderFields() {
      ...
      if (this.definition.array) {
        return this.currentValue.map(function (currentValue) {
          return _this8.renderSingleFields(currentValue);
        });
      } else {
    ...
    value: function renderSingleFields(currentValue) {
      ...
      var formProps = this.getFormProps(currentValue);
      return h(FormComponent, helper_default()([{}, {
        ...
        return _this9.wrapGroup(group);
      }), this.renderDeleteSubFormButton(currentValue), this.$slots.append]);
    }
  }, {
    ...
    value: function renderDeleteSubFormButton(value) {
      var _this11 = this;

      var h = this.$createElement;
      var ButtonComponent = getButtonComponent();
      return this.definition.array && this.currentValue.length > 1 && this.mode !== 'display' ? h("div", {
        "class": "delete-profile-enhan"
      }, [h(ButtonComponent, {
        "attrs": {
          "disabled": this.disabled,
          "text": true,
        ...
        "on": {
          "click": function click() {
            _this11.currentValue.splice(_this11.currentValue.indexOf(value), 1);
          }
        }
      }, ["\u5220\u9664\u8BE5\u6761"])]) : null;
    }
    ...
    value: function onFieldValueChange(value, field) {
      this.$emit('change', this.currentValue);
    }
  }, {
    key: "getFormProps",
    value: function getFormProps(currentValue) {
      var _this12 = this;
          ...
          formProps.title = h("div", {
            ...
            "on": {
              "click": function click(e) {
                _this12.$emit('removeArrayItem', _this12.arrayIndex);
              }
            }
          }, [h("ae-icon", {
            "attrs": {
    ...
    key: "realFields",
    get: function get() {
      return this.definition.fields.filter(function (it) {
    ...
    get: function get() {
      ...
      var rules = {};
      this.realFields.map(function (field) {
        if (field.required) {
          addRule(rules, field, {
            required: true,
    ...
    key: "getPropertyValueByPath",
    value: function getPropertyValueByPath(property, currentValue) {
...
__decorate([Prop(Object)], form_SchemaForm.prototype, "definition", void 0);
...
__decorate([Prop([Array, Object])], form_SchemaForm.prototype, "value", void 0);
...
__decorate([Prop(Object)], form_SchemaForm.prototype, "rules", void 0);

__decorate([Prop()], form_SchemaForm.prototype, "title", void 0);
...
__decorate([Prop({
  type: Number
})], form_SchemaForm.prototype, "arrayIndex", void 0);

__decorate([Watch('currentValue', {
  deep: true
})], form_SchemaForm.prototype, "currentValueChanged", null);

__decorate([Watch('definitions')], form_SchemaForm.prototype, "definitionsChanged", null);

__decorate([Watch('platform')], form_SchemaForm.prototype, "platformChanged", null);

__decorate([Watch('definition.mode')], form_SchemaForm.prototype, "modeChanged", null);

__decorate([Watch('value', {
  immediate: true,
  deep: true
})], form_SchemaForm.prototype, "valueChanged", null);

form_SchemaForm = SchemaForm_1 = __decorate([vue_class_component_esm({
  name: ASchemaForm
})], form_SchemaForm);
/* harmony default export */ var schema_form_form = (form_SchemaForm);
// EXTERNAL MODULE: ./src/schema-form/style.less
var style = __webpack_require__("b71c");
