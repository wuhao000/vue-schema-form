...
plain_display_field_PlainDisplayField = __decorate([vue_class_component_common_default()({
  name: 'DisplayField'
...
time_display_field_DisplayField = __decorate([vue_class_component_common_default()({
...
register(ASchemaForm, DESKTOP, ['SubForm', 'sub-form'], false, function (definition) {
  return {
    platform: DESKTOP,
    definition: {
...
register(ASchemaForm, MOBILE, ['SubForm', 'sub-form'], false, function (definition) {
  return {
...
function registerElement() {
  ...
  register('el-input', DESKTOP, [TYPES.text], false, function (definition) {
    return {
      type: 'textarea'
    };
  });
...
function search(components, platform, definition) {
  var matchedComponents = components.filter(function (it) {
    return it.platform === platform && it.type === definition.type;
  });

  if (matchedComponents.length > 0) {
    var defaultArrayComponent = {
    ...
    if (matchedComponents.length === 1) {
      ...
      if (definition.array) {
        return matchedComponents.find(function (it) {
          return it.forArray;
...
function (_Vue) {
  ...
  _createClass(FormField, [{
    ...
    value: function render() {
      ...
      var componentAttrs = Object.assign({}, props);
      ...
      if (platform === 'desktop') {
        var formItem = this.definition.type === 'SubForm' ? component : h(FormItemComponent, {
          "attrs": {
    ...
    get: function get() {
      ...
      var props = this.componentType.getProps(definition);
...
field_FormField = __decorate([vue_class_component_common_default()({
  name: 'FormField'
})], field_FormField);
  ...
  _createClass(SchemaForm, [{
    ...
    value: function renderButtons() {
      ...
      if (props && this.mode === 'edit') {
        if (this.platform === 'mobile') {
          return h("div", {
          ...
          }, [props.onOk ? h("m-white-space") : null, props.onOk ? h("m-button", helper_default()([{
            "attrs": {
              "type": "primary"
            }
          }, {
            ...
            "on": {
              "click": props && props.onOk
            }
          }]), [props && props.okText || '保存']) : null, props.onCancel ? h("m-white-space") : null, props.onCancel ? h("m-button", helper_default()([{
            "on": {
              "click": props && props.onCancel
            }
          }, {
            "attrs": props && props.cancelProps
          }]), [props && props.cancelText || '取消']) : null]);
        } else {
          return h("div", {
            "class": "action-buttons"
          }, [props.onCancel ? h("d-button", helper_default()([{
            "on": {
              "click": props && props.onCancel
            },
            "class": "cancel-button"
            ...
            "attrs": props && props.cancelProps
          }]), [props && props.cancelText || '取消']) : null, props.onOk ? h("d-button", helper_default()([{
            "attrs": {
              "type": "primary"
            },
    ...
    value: function getGroups(currentValue) {
      ...
      this.realFields.forEach(function (field, index) {
        var vnode = _this4.renderField(field, currentValue, index);
      ...
      if (!definition.depends) {
        ...
        if (typeof definition.depends === 'function') {
          ...
          return !definition.depends.map(function (condition) {
            return _this5.matchCondition(condition);
          }).some(function (it) {
            return !it;
          });
        }
    ...
    value: function renderField(field, currentValue, index) {
      ...
      return this.calcShowState(field) ? h(schema_form_field, {
        ...
        "model": {
          ...
          callback: function callback($$v) {
            _this6.$set(value, propertyName, $$v);
          }
        }
      }) : null;
    }
    ...
    value: function renderFields() {
      ...
      if (this.definition.array) {
        return this.currentValue.map(function (currentValue) {
          return _this7.renderSingleFields(currentValue);
        });
      } else {
    ...
    value: function renderSingleFields(currentValue) {
      ...
      return h(FormComponent, helper_default()([{}, {
        ...
        "on": formEvents
      }]), [!this.definition.array && this.platform === 'desktop' ? this.renderTitle() : null, props && props.inline ? groups.reduce(function (a, b) {
        return a.concat(b);
    ...
    value: function renderDeleteSubFormButton(value) {
      ...
      return this.definition.array && this.currentValue.length > 1 ? h("div", {
        ...
        "on": {
          "click": function click() {
            _this9.currentValue.splice(_this9.currentValue.indexOf(value), 1);
          }
        },
        "attrs": {
          "text": true,
...
form_SchemaForm = SchemaForm_1 = __decorate([vue_class_component_common_default()({
  name: ASchemaForm
})], form_SchemaForm);
