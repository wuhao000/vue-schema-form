  ...
  render: function render() {
    ...
    var content = [this.current.map(function (v, index) {
      var input = h(InputComponent, helper_default()([{}, {
        "attrs": Object.assign({}, _this.$attrs)
      }, {
        "model": {
...
external_Vue_default.a.component('BaseArrayComponent', base_array_component);
...
function registerAntd() {
  ...
  register('d-date-picker', DESKTOP, [TYPES.date, TYPES.datetime], false, function (definition) {
    return {
...
function registerElement() {
  ...
  register('el-date-picker', DESKTOP, [TYPES.datetime, TYPES.date, TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
...
function registerAntdMobile() {
  ...
  register('m-date-picker', MOBILE, [TYPES.date, TYPES.datetime, TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
...
function (_Vue) {
  ...
  function FormField() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(FormField).apply(this, arguments));
  }
  ...
  _createClass(FormField, [{
    ...
    value: function render() {
      ...
      var component = this.content ? this.content : h(InputFieldDefinition, helper_default()([{}, {
        "attrs": props
      }, {
        "attrs": {
          "value": currentValue,
...
function (_Vue) {
  ...
  _createClass(SchemaForm, [{
    ...
    value: function renderButtons() {
      ...
      if (props && this.mode === 'edit') {
        ...
        if (this.platform === 'mobile') {
          ...
          }]), [props && props.cancelText || '取消']) : null, this.hasListener('cancel') ? h("m-white-space") : null, this.hasListener('reset') ? h("m-button", helper_default()([{
            "attrs": {
              "type": "error"
            },
            "on": {
    ...
    value: function renderDeleteSubFormButton(value) {
      ...
      var h = this.$createElement;
      var ButtonComponent = getButtonComponent();
      return this.definition.array && this.currentValue.length > 1 ? h("div", {
    ...
    get: function get() {
      ...
      var rules = {};
      this.definition.fields.map(function (field) {
        if (field.required) {
          addRule(rules, field, {
            required: true,
