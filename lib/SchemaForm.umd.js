...
/* harmony import */ var _accessor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("af6b");
/* harmony import */ var _array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("4ed9");
/* harmony import */ var _isEmpty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("cf71");
...
var getSchemaNodeFromPath = function getSchemaNodeFromPath(schema, path) {
  var res = schema;
  var suc = 0;
  var copyPath = Object(_array__WEBPACK_IMPORTED_MODULE_2__[/* toArr */ "d"])(path);

  for (var i = 0; i < copyPath.length; i++) {
    var key = copyPath[i];

    if (res && !Object(_isEmpty__WEBPACK_IMPORTED_MODULE_3__[/* isEmpty */ "a"])(res.properties)) {
      res = res.properties[key];
      suc++;
    } else if (res && !Object(_isEmpty__WEBPACK_IMPORTED_MODULE_3__[/* isEmpty */ "a"])(res.items) && numberRE.test(key)) {
      res = res.items;
      suc++;
    }
  }
...
var schemaTraverse = function schemaTraverse(schema, callback) {
  ...
  if (schema) {
    ...
    if (schemaIs(schema, 'object') || schema.properties) {
      Object(_array__WEBPACK_IMPORTED_MODULE_2__[/* each */ "a"])(schema.properties, function (subSchema, key) {
...
var calculateSchemaInitialValues = function calculateSchemaInitialValues(schema, initialValues, callback) {
  ...
  schemaTraverse(schema, function (subSchema, $path, parentPath) {
    ...
    if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isFn"])($path) && parentPath) {
      Object(_array__WEBPACK_IMPORTED_MODULE_2__[/* each */ "a"])(Object(_array__WEBPACK_IMPORTED_MODULE_2__[/* toArr */ "d"])(Object(_accessor__WEBPACK_IMPORTED_MODULE_1__[/* getIn */ "a"])(initialValues, parentPath)), function (value, index) {
        $path(index);
      });
    } else if ($path) {
      var isVirtualBoxInstance = isVirtualBoxSchema(subSchema);
      var name = isVirtualBoxInstance ? $path.schemaPath.join('.') : $path.path.join('.');
      var path = isVirtualBoxInstance ? $path.schemaPath : $path.path;
      var schemaPath = $path.schemaPath;
      var initialValue = Object(_accessor__WEBPACK_IMPORTED_MODULE_1__[/* getIn */ "a"])(initialValues, name);
      var value = !Object(_isEmpty__WEBPACK_IMPORTED_MODULE_3__[/* isEmpty */ "a"])(initialValue) ? initialValue : defaultValue;

      if (!Object(_isEmpty__WEBPACK_IMPORTED_MODULE_3__[/* isEmpty */ "a"])(value)) {
        Object(_accessor__WEBPACK_IMPORTED_MODULE_1__[/* setIn */ "c"])(initialValues, name, value);
      }

      if (callback && Object(_types__WEBPACK_IMPORTED_MODULE_0__["isFn"])(callback)) {
        var newPath = {
          name: name,
          path: path,
          schemaPath: schemaPath
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return toArr; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isStr", function() { return _types__WEBPACK_IMPORTED_MODULE_1__["f"]; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return isStr; });
...
// which add an implementation for Reflect.defineMetadata but not for Reflect.getOwnMetadataKeys.
// Without this check consumers will encounter hard to track down runtime errors.
var vue_class_component_esm_reflectionIsSupported = typeof Reflect !== 'undefined' && Reflect.defineMetadata && Reflect.getOwnMetadataKeys;
function vue_class_component_esm_copyReflectionMetadata(to, from) {
    vue_class_component_esm_forwardMetadata(to, from);
    Object.getOwnPropertyNames(from.prototype).forEach(function (key) {
        vue_class_component_esm_forwardMetadata(to.prototype, from.prototype, key);
    });
    Object.getOwnPropertyNames(from).forEach(function (key) {
        vue_class_component_esm_forwardMetadata(to, from, key);
    });
}
function vue_class_component_esm_forwardMetadata(to, from, propertyKey) {
    var metaKeys = propertyKey
        ? Reflect.getOwnMetadataKeys(from, propertyKey)
        : Reflect.getOwnMetadataKeys(from);
    metaKeys.forEach(function (metaKey) {
...
var vue_class_component_esm_fakeArray = { __proto__: [] };
var vue_class_component_esm_hasProto = vue_class_component_esm_fakeArray instanceof Array;
...
function vue_class_component_esm_collectDataFromConstructor(vm, Component) {
    // override _init to prevent to init as Vue instance
    var originalInit = Component.prototype._init;
    Component.prototype._init = function () {
        var _this = this;
...
var vue_class_component_esm_$internalHooks = [
    'data',
    'beforeCreate',
    'created',
    'beforeMount',
...
function vue_class_component_esm_componentFactory(Component, options) {
    if (options === void 0) { options = {}; }
    options.name = options.name || Component._componentTag || Component.name;
    // prototype props.
    var proto = Component.prototype;
    Object.getOwnPropertyNames(proto).forEach(function (key) {
        ...
        // hooks
        if (vue_class_component_esm_$internalHooks.indexOf(key) > -1) {
            options[key] = proto[key];
            return;
        }
        var descriptor = Object.getOwnPropertyDescriptor(proto, key);
    ...
    (options.mixins || (options.mixins = [])).push({
        data: function () {
            return vue_class_component_esm_collectDataFromConstructor(this, Component);
        }
    });
    // decorate options
    var decorators = Component.__decorators__;
    ...
    var Super = superProto instanceof external_Vue_default.a
        ...
        : external_Vue_default.a;
    var Extended = Super.extend(options);
    vue_class_component_esm_forwardStaticMembers(Extended, Component, Super);
    if (vue_class_component_esm_reflectionIsSupported) {
        vue_class_component_esm_copyReflectionMetadata(Extended, Component);
    }
    return Extended;
}
var vue_class_component_esm_reservedPropertyNames = [
    // Unique id
    'cid',
    // Super Vue constructor
    'super',
...
var vue_class_component_esm_shouldIgnore = {
    prototype: true,
    arguments: true,
    callee: true,
    caller: true
};
function vue_class_component_esm_forwardStaticMembers(Extended, Original, Super) {
    // We have to use getOwnPropertyNames since Babel registers methods as non-enumerable
    Object.getOwnPropertyNames(Original).forEach(function (key) {
        // Skip the properties that should not be overwritten
        if (vue_class_component_esm_shouldIgnore[key]) {
            return;
        }
        // Some browsers does not allow reconfigure built-in properties
        var extendedDescriptor = Object.getOwnPropertyDescriptor(Extended, key);
        ...
        if (!vue_class_component_esm_hasProto) {
            ...
            var superDescriptor = Object.getOwnPropertyDescriptor(Super, key);
            if (!vue_class_component_esm_isPrimitive(descriptor.value) &&
                superDescriptor &&
                superDescriptor.value === descriptor.value) {
                return;
            }
...
function dist_vue_class_component_esm_Component(options) {
    if (typeof options === 'function') {
        return vue_class_component_esm_componentFactory(options);
    }
    return function (Component) {
        return vue_class_component_esm_componentFactory(Component, options);
    };
}
dist_vue_class_component_esm_Component.registerHooks = function registerHooks(keys) {
    vue_class_component_esm_$internalHooks.push.apply(vue_class_component_esm_$internalHooks, keys);
};

/* harmony default export */ var dist_vue_class_component_esm = (dist_vue_class_component_esm_Component);
...
function Inject(options) {
    return vue_class_component_esm_createDecorator(function (componentOptions, key) {
...
function Provide(key) {
    return vue_class_component_esm_createDecorator(function (componentOptions, k) {
...
var field_getFieldValue = function getFieldValue(value, field) {
  if (field.processor) {
...
// CONCATENATED MODULE: ./src/schema-form/internal/base-form.tsx
...
var base_form_BaseForm =
/*#__PURE__*/
function (_Vue) {
  _inherits(BaseForm, _Vue);

  function BaseForm() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, BaseForm);

    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(BaseForm).apply(this, arguments));
    _this.currentValue = null;
    _this.fields = [];
    return _this;
  }

  Object(createClass["a" /* default */])(BaseForm, [{
    ...
    key: "definitionsChanged",
    value: function definitionsChanged() {
    ...
    key: "platformChanged",
    value: function platformChanged() {
      this.$forceUpdate();
    }
  }, {
    key: "valueChanged",
    ...
    value: function setDefaultValue(property, tmpValue, fieldDef) {
      ...
      splits.forEach(function (name, index) {
        if (index < splits.length - 1) {
          if (!copy[name]) {
            _this2.$set(copy, name, {});
          }

          copy = copy[name];
        } else {
          copy[name] = getDefaultValue(_this2.createField(fieldDef));
        }
      });
    }
  }, {
    key: "buildExtraProperties",
    value: function buildExtraProperties() {
      var _this3 = this;

      var value = this.value;
      var currentValue = this.currentValue;
      this.realFields.forEach(function (fieldDef) {
        var field = _this3.createField(fieldDef);

        if (typeof field.destructPath.destruct === 'string') {
          var property = fieldDef.property;

          if (_this3.definition.array) {
            if (!currentValue || !Array.isArray(currentValue)) {
              currentValue = [];
            }

            currentValue.forEach(function (tmpValue) {
              if (property.includes('.')) {
                _this3.setDefaultValue(property, tmpValue, fieldDef);
              } else {
                if (!tmpValue || tmpValue[property] === undefined) {
                  _this3.$set(tmpValue, property, getDefaultValue(field));
                } else if (value && value.length) {
                  _this3.$set(tmpValue, property, value[0][fieldDef.property]);
                }
              }
            });
          } else {
            ...
            if (property.includes('.')) {
              ...
              if (!tmpValue || tmpValue[property] === undefined) {
                ...
                _this3.$set(tmpValue, property, value[fieldDef.property]);
              }
            }
          }
        }
    ...
    value: function render() {
      ...
      return h("div", {
        "class": "schema-form"
      }, [this.$slots.header, this.definition.array ? this.renderTitle() : null, this.renderFields(), this.renderAddFormButton(), this.renderButtons(), this.$slots.footer]);
    }
  }, {
    key: "renderButtons",
    value: function renderButtons() {
      ...
      if (props && this.mode === 'edit') {
        ...
        if (this.platform === 'mobile') {
          return h("div", {
            "class": "action-btns"
          }, [this.hasListener('ok') ? h("m-white-space") : null, this.hasListener('ok') ? h("m-button", helper_default()([{
            "attrs": {
              "type": "primary",
          ...
          }]), [props && props.okText || '保存']) : null, this.hasListener('cancel') ? h("m-white-space") : null, this.hasListener('cancel') ? h("m-button", helper_default()([{
            "attrs": {
          ...
          }]), [props && props.cancelText || '取消']) : null, this.hasListener('reset') ? h("m-white-space") : null, this.hasListener('reset') ? h("m-button", helper_default()([{
            "attrs": {
          ...
          }]), [props && props.resetText || '重置']) : null]);
        } else {
          return h("div", {
            "class": "action-btns"
          }, [this.hasListener('cancel') ? h(ButtonComponent, helper_default()([{
            "attrs": {
              "disabled": this.isDisabled || this.isLoading
            },
            "on": {
            ...
            "attrs": props && props.cancelProps
          }]), [props && props.cancelText || '取消']) : null, this.hasListener('ok') ? h(ButtonComponent, helper_default()([{
            "attrs": {
              "type": "primary",
              "disabled": this.isDisabled,
              "loading": this.isLoading
          ...
          }]), [props && props.okText || '保存']) : null, this.hasListener('reset') ? h(ButtonComponent, helper_default()([{
            "attrs": {
              "type": "danger",
              "disabled": this.isDisabled || this.isLoading
            },
            ...
            "on": {
              "click": function click() {
                _this4.$emit('reset', _this4.currentValue);
              }
            }
          }]), [props && props.resetText || '重置']) : null]);
        }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                valid = _context.sent;
                errors = valid.filter(function (it) {
                  return it && it !== true;
                }).flat();
    ...
    value: function getGroups(currentValue) {
      ...
      this.realFields.forEach(function (field, index) {
        var vnode = _this5.renderField(field, currentValue, index);
    ...
    key: "calcShowState",
    value: function calcShowState(definition) {
      var _this6 = this;
      ...
      if (!definition.depends) {
        ...
        if (typeof definition.depends === 'function') {
          ...
          return !definition.depends.map(function (condition) {
            return _this6.matchCondition(condition);
          }).some(function (it) {
            return !it;
          });
        }
    ...
    key: "matchCondition",
    value: function matchCondition(condition) {
      if (!this.currentValue) {
        return false;
      } else {
        var currentValue = this.currentValue[condition.property];
    ...
    key: "renderField",
    value: function renderField(field, currentValue, index) {
      var h = this.$createElement;
      ...
      var iField = this.createField(field); // @ts-ignore

      return h(schema_form_field, {
        "attrs": {
          "value": field_getFieldValue(value, iField),
          "field": iField,
    ...
    value: function renderSingleFields(currentValue) {
      ...
      var h = this.$createElement;
      var props = this.props;
      var FormComponent = getFormComponent(this.platform);
      var groups = this.getGroups(currentValue);
      var formProps = this.getFormProps();
      return h(FormComponent, helper_default()([{}, {
        "attrs": formProps
      }, {
        "ref": "form"
      }, {
        "on": this.$listeners
      }]), [this.$slots.prepend, !this.definition.array && this.isDesktop ? this.renderTitle() : null, props && props.inline ? groups.reduce(function (a, b) {
        return a.concat(b);
      }) : groups.map(function (group) {
        return _this7.wrapGroup(group);
      }), this.renderDeleteSubFormButton(), this.$slots.append]);
    }
  }, {
    ...
    key: "renderDeleteSubFormButton",
    value: function renderDeleteSubFormButton() {
      var _this9 = this;

      var h = this.$createElement;
      var ButtonComponent = getButtonComponent();
      return Number.isInteger(this.arrayIndex) && this.mode !== 'display' && this.platform === 'desktop' ? h("div", {
        "class": "delete-item-butn-wrapper",
        "style": {
          textAlign: 'right'
        }
      }, [h(ButtonComponent, {
    ...
    value: function createField(definition) {
      var plainPath = this.buildFieldPath(definition).join('.');
      var existsField = this['store'].fields[plainPath];
    ...
    key: "hasListener",
    value: function hasListener(event) {
    ...
    value: function getFormProps() {
      ...
      if (this.isMobile) {
        ...
        if (this.arrayIndex !== null && this.arrayIndex !== undefined) {
          formProps.title = h("div", {
            "style": {
              display: 'flex',
              justifyContent: 'space-between'
            }
          }, [h("span", [title + ' (' + (this.arrayIndex + 1) + ')']), this.arrayIndex > 0 ? h("a", {
            "style": {
              color: '#e94721',
              cursor: 'pointer'
            },
            "on": {
              "click": function click() {
                _this10.$emit('removeArrayItem', _this10.arrayIndex);
              }
            }
          }, [h("ae-icon", {
            "attrs": {
    ...
    value: function validate() {
      ...
      if (fields.length) {
        return Promise.all(fields.map(function (it) {
          return it.validate();
        }));
      }
    ...
    key: "buildArrayPath",
    value: function buildArrayPath(field) {
      if (this.pathPrefix) {
    ...
    key: "buildFieldPath",
    value: function buildFieldPath(field) {
      if (this.pathPrefix) {
        return this.pathPrefix.concat(field.property);
      } else {
...
__decorate([Prop(Object)], base_form_BaseForm.prototype, "definition", void 0);

__decorate([Prop({
  type: String,
  default: 'desktop'
})], base_form_BaseForm.prototype, "platform", void 0);
...
})], base_form_BaseForm.prototype, "props", void 0);

__decorate([Prop([Array, Object])], base_form_BaseForm.prototype, "value", void 0);

__decorate([Prop({
  type: String,
  default: 'edit'
})], base_form_BaseForm.prototype, "mode", void 0);

__decorate([Prop({
  type: Boolean,
  default: false
})], base_form_BaseForm.prototype, "inline", void 0);

__decorate([Prop(Object)], base_form_BaseForm.prototype, "rules", void 0);

__decorate([Prop()], base_form_BaseForm.prototype, "title", void 0);

__decorate([Prop({
  type: Number
})], base_form_BaseForm.prototype, "arrayIndex", void 0);

__decorate([Prop(Array)], base_form_BaseForm.prototype, "pathPrefix", void 0);

__decorate([Prop()], base_form_BaseForm.prototype, "effects", void 0);

__decorate([Watch('currentValue', {
  deep: true
})], base_form_BaseForm.prototype, "currentValueChanged", null);

__decorate([Watch('definitions')], base_form_BaseForm.prototype, "definitionsChanged", null);

__decorate([Watch('platform')], base_form_BaseForm.prototype, "platformChanged", null);

__decorate([Watch('value', {
  immediate: true,
  deep: true
})], base_form_BaseForm.prototype, "valueChanged", null);

base_form_BaseForm = __decorate([vue_class_component_esm({
  name: 'BaseForm'
})], base_form_BaseForm);
/* harmony default export */ var base_form = (base_form_BaseForm);
...
/* harmony default export */ var uploadvue_type_script_lang_ts_ = (external_Vue_default.a.extend({
  name: 'AntdUpload',
  props: {
    value: {
      type: [String, Array]
...
var upload_component = normalizeComponent(
  ...
  uploadvue_type_template_id_b4d2f07c_render,
  staticRenderFns,
  false,
  null,
  null,
...
var select_display_field_DisplayField =
/*#__PURE__*/
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(DisplayField, [{
    ...
    value: function render() {
      ...
      var definition = this.definition,
          value = this.value;
      var options = utils_getOptions(definition);
      ...
      if (value) {
        ...
        if (this.definition.array) {
          selected = options.filter(function (it) {
            return value.includes(it[_this.valueProperty]);
          });
        } else {
          selected = options.filter(function (it) {
            return value === it[_this.valueProperty];
          });
        }

        return h("span", [selected.map(function (it) {
          return it[_this.LabelProperty];
        }).join('、')]);
      } else {
        return h("span");
      }
...
__decorate([Prop()], select_display_field_DisplayField.prototype, "value", void 0);

__decorate([Prop(Object)], select_display_field_DisplayField.prototype, "definition", void 0);

select_display_field_DisplayField = __decorate([vue_class_component_esm({
  name: 'SelectDisplayField'
})], select_display_field_DisplayField);
/* harmony default export */ var select_display_field = (select_display_field_DisplayField);
...
// CONCATENATED MODULE: ./src/schema-form/utils.tsx
...
var DESKTOP = 'desktop';
var MOBILE = 'mobile';
var formComponent = 'd-form';
var rowComponent = 'd-row';
var colComponent = 'd-col';
var buttonComponent = 'd-button';
var alertComponent = 'a-alert';
var confirmFunction = '$dconfirm';
var SchemaFormComponentDefinitions = [];
var DisplayComponentDefinitions = [];
var registerDisplay = function registerDisplay(component, platform, type) {
...
var register = function register(component, platform, types) {
  var forArray = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var getProps = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function () {
    return {};
  };
...
var addComponent = function addComponent(component, platforms, types) {
  var forArray = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;

  var _getProps = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function () {
    return {};
  };

  var forDisplay = arguments.length > 5 ? arguments[5] : undefined;

  if (Array.isArray(types)) {
    types.forEach(function (type) {
      addComponent(component, platforms, type, forArray, _getProps, forDisplay);
    });
  } else if (Array.isArray(platforms)) {
    platforms.forEach(function (platform) {
      addComponent(component, platform, types, forArray, _getProps, forDisplay);
    });
  } else {
    var def = {
      component: component,
      ...
      getProps: function getProps(definition) {
        var props = _getProps(definition, platforms) || {};
    ...
    var mode = forDisplay ? 'display' : 'edit';
    var typeDef = store[mode][platforms];
...
registerDisplay(time_display_field, [DESKTOP, MOBILE], [TYPES.datetime, TYPES.date]);
registerDisplay(plain_display_field, [DESKTOP, MOBILE], [TYPES.string, TYPES.text, TYPES.url, TYPES.integer, TYPES.double, TYPES.number], false);
registerDisplay(select_display_field, [DESKTOP, MOBILE], [TYPES.select, TYPES.expandSelect], null);
...
function registerAntd() {
  ...
  register('d-date-picker', DESKTOP, [TYPES.date, TYPES.year, TYPES.month, TYPES.datetime], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register('d-time-picker', DESKTOP, [TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  ...
  register('d-select', DESKTOP, TYPES.select, null, function (definition) {
    return {
      dropdownMatchSelectWidth: false,
      multiple: definition.array
    };
  });
  register(upload, DESKTOP, TYPES.upload, null, function (def) {
    return {
      multiple: def.array
    };
  });
  ...
  register('d-transfer', DESKTOP, TYPES.transfer, false, function (def) {
...
function registerElement() {
  ...
  register('el-input', DESKTOP, [TYPES.text], false, function () {
    return {
      type: 'textarea'
    };
  });
  register('el-date-picker', DESKTOP, [TYPES.date, TYPES.year, TYPES.month, TYPES.datetime], false, function (definition) {
    return {
  ...
  register('el-ext-select', DESKTOP, [TYPES.select], null, function (definition) {
    return {
      multiple: definition.array
    };
  });
...
function registerAntdMobile() {
  ...
  register('m-date-picker-item', MOBILE, [TYPES.date, TYPES.datetime, TYPES.month, TYPES.year, TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register('m-input', MOBILE, [TYPES.integer, TYPES.double, TYPES.number], false, function (definition) {
    return {
...
function searchStore(mode, platform, definition) {
  var typeDef = store[mode][platform][definition.type];
...
var utils_getOptions = function getOptions(definition) {
  if (definition.enum) {
  ...
  if (definition.props && definition.props.options) {
    ...
    } else if (Object(esm_typeof["a" /* default */])(definition.props.options) === 'object') {
      return definition.props.options || [];
    }
  } else {
    return [];
...
function (_Vue) {
  ...
  Object(createClass["a" /* default */])(ArrayWrapper, [{
    ...
    value: function render() {
      var h = arguments[0];
      var RowComponent = getRowComponent();
      var content = [this.$slots.default, this.renderAddButton()];
...
// CONCATENATED MODULE: ./src/schema-form/field.tsx
...
function (_mixins) {
  ...
  Object(createClass["a" /* default */])(FormField, [{
    ...
    value: function renderInputComponent() {
      ...
      var inputFieldDef = this.componentType;
      ...
      if (this.field.array && inputFieldDef.forArray === false) {
        ...
        return h(array_wrapper, {
        ...
        }, [this.currentValue ? this.currentValue.map(function (v, index) {
          var itemProps = Object.assign({}, props, {
            pathPrefix: _this2.path.concat(index)
          });

          if (_this2.field.type === TYPES.object) {
          ...
          return h(InputFieldComponent, helper_default()([{}, {
            ...
            "attrs": {
              ...
              "value": v,
              "title": _this2.platform === 'mobile' ? _this2.field.title : null
            },
            "on": {
              "removeArrayItem": function removeArrayItem() {
                ...
                regeneratorRuntime.mark(function _callee() {
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          confirmFunc = getConfirmFunction(this.platform);
                          _context.next = 3;
                          return this[confirmFunc]('确定删除该条吗？', '提示');
              ...
              "input": function input(val) {
                _this2.onArrayItemInput(val, index);
              }
            }
          }]));
        }) : null]);
    ...
    value: function render() {
      ...
      var component = this.renderInputComponent();
      var item = null;
      var FormItemComponent = this.formItemComponent;
      var ColComponent = getColComponent();

      if (platform === DESKTOP) {
        var formItem = field.type === TYPES.object ? component : h(FormItemComponent, helper_default()([{}, {
          "attrs": this.getFormItemProps()
        }]), [component, this.renderNotice()]);
    ...
    value: function getRules() {
      ...
      if (rules.length === 0) {
        ...
        if (typeof field.min === 'number') {
          addRule(rules, field, {
            min: field.min,
            message: "".concat(field.title, "\u4E0D\u80FD\u5C0F\u4E8E").concat(field.min)
          });
        }
        ...
        if (typeof field.max === 'number') {
          addRule(rules, field, {
            max: field.max,
            message: "".concat(field.title, "\u4E0D\u80FD\u5927\u4E8E").concat(field.max)
          });
        }
      }
    ...
    value: function renderNotice() {
      var h = this.$createElement;
      var AlertComponent = getAlertComponent();

      if (this.definition.notice) {
        return h(AlertComponent, {
          "attrs": {
            "message": this.definition.notice
          }
        });
      }
    }
    ...
    value: function getFormItemProps() {
      var definition = this.definition;
      var component = this.formItemComponent;
      var props = {
    ...
    value: function validate() {
      ...
      if (this.definition.type === TYPES.object && this.$refs.array) {
      ...
      if (rules.length) {
        ...
        if ([TYPES.integer, TYPES.double, TYPES.number].includes(this.field.type)) {
    ...
    get: function get() {
      ...
      if (component.component === 'empty') {
        console.warn("\u7C7B\u578B".concat(this.field.type).concat(this.field.array ? '（数组）' : '', "\u6CA1\u6709\u5BF9\u5E94\u7684").concat(this.display ? '展示' : '编辑', "\u7EC4\u4EF6"));
      }
    ...
    get: function get() {
      var field = this.field;
      var props = Object.assign({}, this.componentType.getProps(field));
      var type = field.type;
...
__decorate([Prop({
  type: Boolean,
  default: false
})], field_FormField.prototype, "display", void 0);

__decorate([Prop({
  type: String,
  default: 'mobile'
})], field_FormField.prototype, "platform", void 0);
...
/* harmony default export */ var schema_form_field = (field_FormField);
...
function (_mixins) {
  ...
  Object(createClass["a" /* default */])(SchemaForm, [{
    ...
    value: function createContext() {
      ...
      return function (paths) {
        ...
        if (typeof paths === 'string') {
          fields.push(_this2['store'].fields[paths]);
        ...
        fields = fields.filter(function (it) {
          return !!it;
        });
        return {
          hide: function hide() {
          ...
          setEnum: function setEnum(options) {
            fields.forEach(function (field) {
              field.props = Object.assign(field.props, {
                options: options
              });
            });
          },
    ...
    value: function created() {
      ...
      this.$on('SchemaForm.addField', function (field) {
        if (field) {
      ...
      this.$on('SchemaForm.addSchemaField', function (field) {
        if (field) {
          _this3.store.fields[field.plainPath] = field;
        }
      });
      this.$on('SchemaForm.removeField', function (field) {
        if (field.prop) {
      ...
      this.$on('SchemaForm.removeSchemaField', function (field) {
        if (field) {
          delete _this3.store.fields[field.plainPath];
        }
      });
    }
  }]);
...
__decorate([Watch('mode', {
  immediate: true
})], form_SchemaForm.prototype, "modeChanged", null);
...
// EXTERNAL MODULE: ./src/schema-form/style.less
var schema_form_style = __webpack_require__("b71c");

// CONCATENATED MODULE: ./src/schema-form/index.ts



schema_form_form.Field = schema_form_field;

schema_form_form.install = function (Vue) {
  Vue.component('ASchemaForm', schema_form_form);
  Vue.component('ASchemaFormField', schema_form_form.Field);
};
