...
function (_Vue) {
  ...
  _createClass(SchemaForm, [{
    ...
    value: function render() {
      ...
      return h("div", {
        "class": "schema-form"
      }, [this.definition.array ? this.renderTitle() : null, this.renderFields(), this.renderAddFormButton(), this.renderButtons()]);
    }
  }, {
    key: "renderButtons",
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(this.form && this.rules && this.form.validate)) {
                  _context.next = 8;
                  break;
                }
    ...
    value: function renderField(field, currentValue, index) {
      ...
      return this.calcShowState(field) ? h(schema_form_field, {
        "attrs": {
          "validate": !!(this.props && this.rules),
    ...
    value: function renderSingleFields(currentValue) {
      ...
      return h(FormComponent, helper_default()([{}, {
        ...
        "on": this.$listeners
      }]), [!this.definition.array && this.isDesktop ? this.renderTitle() : null, props && props.inline ? groups.reduce(function (a, b) {
        return a.concat(b);
