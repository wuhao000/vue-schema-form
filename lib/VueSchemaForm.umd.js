(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueSchemaForm"] = factory(require("Vue"));
	else
		root["VueSchemaForm"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./src/schema-form/element/input-array.tsx




/* harmony default export */ var input_array = ({
  props: {
    value: Array,
    cellSpan: {
      type: Number,
  ...
  render: function render() {
    ...
    }, [this.current.map(function (v, index) {
      return h("el-col", {
        "attrs": {
          "span": _this.cellSpan
        }
...
/* harmony default export */ var element_select = ({
  ...
  render: function render() {
    ...
    return h("el-select", helper_default()([{}, {
      ...
      return h("el-option", {
        "attrs": {
          "label": getOptionProperty(option, _this.labelProperty),
          "value": getOptionProperty(option, _this.valueProperty)
        }
      });
    })]);
  }
...
var register = function register(component, platform, type) {
  var forArray = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var getProps = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function () {
    return {};
  };
...
var addComponent = function addComponent(component, platform, type) {
  var forArray = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  var def = {
    ...
    getProps: function getProps(definition) {
      var props = _getProps(definition, platform) || {};
...
function registerAntd() {
  ...
  register('d-date-picker', 'desktop', ['DateTime', 'Date', 'Time'], null, function (definition) {
    return {
  ...
  register('d-select', 'desktop', 'Select', null, function (definition) {
    return {
...
function registerElement() {
  ...
  rowComponent = 'el-row';
  colComponent = 'el-col';
  external_Vue_default.a.component('ElExtSelect', element_select);
  external_Vue_default.a.component('ElInputArray', input_array);
  register('el-input', 'desktop', ['String', 'Url']);
  register('el-input', 'desktop', 'Text', null, function (definition) {
    return {
      type: 'textarea'
    };
  });
  register('el-input-array', 'desktop', ['String', 'Url'], true);
  register('el-input-array', 'desktop', 'Text', true, function () {
    return {
      type: 'textarea'
    };
  });
  register('el-date-picker', 'desktop', ['DateTime', 'Date', 'Time'], null, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
...
function registerAntdMobile() {
  ...
  register('m-date-picker', 'desktop', ['DateTime', 'Date', 'Time'], null, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  register('m-input', 'mobile', ['Double', 'Integer'], null, function (definition) {
    return {
      type: definition.type === 'Double' ? 'digit' : 'number',
      textAlign: 'right'
    };
  });
...
function search(components, platform, definition) {
  ...
  if (matchedComponents.length === 1) {
    ...
    if (definition.array) {
      def = matchedComponents.find(function (it) {
        return it.forArray === definition.array;
      });
    } else {
      def = matchedComponents.find(function (it) {
        return !it.forArray;
  ...
  _createClass(FormField, [{
      ...
      if (this.definition.type === 'Integer') {
        if (value !== null && value !== undefined) {
          if (this.definition.array) {
            this.onInput(value.map(function (v) {
              return parseInt(v);
            }));
          } else {
    ...
    value: function calcShowState() {
      ...
      if (!definition.depends) {
        ...
        if (typeof definition.depends === 'function') {
          ...
          this.shouldShowField = !definition.depends.map(function (condition) {
            return _this2.matchCondition(condition);
          }).some(function (it) {
            return !it;
          });
        }
    ...
    value: function matchCondition(condition) {
      if (!this.formValue) {
        ...
        var currentValue = this.formValue[condition.property];
    ...
    value: function render() {
      var h = arguments[0];
      var shouldShowField = this.shouldShowField,
          props = this.props,
          currentValue = this.currentValue,
          definition = this.definition,
          platform = this.platform;
      var InputFieldDefinition = this.componentType.component; // @ts-ignore
      ...
      if (platform === 'desktop') {
        var formItem = h(FormItemComponent, {
          "attrs": {
        ...
        if (definition.span) {
          item = shouldShowField ? h(ColComponent, {
            "attrs": {
...
__decorate([Watch('formValue', {
  deep: true,
  immediate: true
})], field_FormField.prototype, "modelChanged", null);

__decorate([Watch('value')], field_FormField.prototype, "valueChanged", null);
...
function (_Vue) {
  ...
  _createClass(SchemaForm, [{
    ...
    value: function renderField(field, currentValue, index) {
      ...
      var h = this.$createElement;
      var platform = this.definition.platform;
      var value = null;
    ...
    value: function renderSingleFields(currentValue) {
      ...
      var FormComponent = getFormComponent(this.definition.platform);
      ...
      return h(FormComponent, helper_default()([{}, {
        ...
        "on": formEvents
      }]), [!this.definition.array ? this.renderTitle() : null, props && props.inline ? groups.reduce(function (a, b) {
        return a.concat(b);
...
schema_form_form.install = function (Vue) {
  Vue.component('SchemaForm', schema_form_form);
  Vue.component('SchemaFormField', schema_form_form.Field);
};
...
//# sourceMappingURL=VueSchemaForm.umd.js.map