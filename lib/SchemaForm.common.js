...
function registerAntdMobile() {
  ...
  register('m-date-picker-item', MOBILE, [TYPES.date, TYPES.datetime, TYPES.time], false, function (definition) {
    return {
      mode: definition.type.toLowerCase()
    };
  });
  ...
  Object(createClass["a" /* default */])(FormField, [{
    ...
    value: function validate() {
      ...
      if (rules.length) {
        ...
        var model = _defineProperty({}, field.plainPath, this.currentValue);
